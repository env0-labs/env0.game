...
namespace Env0.Act3
{
    public sealed class Act3Module : IActModule
    {
        ...
        private static OutputType MapOutputType(Env0.Act3.Terminal.OutputType type)
        {
            switch (type)
            {
                case Env0.Act3.Terminal.OutputType.Error:
                    return OutputType.Error;
                case Env0.Act3.Terminal.OutputType.System:
